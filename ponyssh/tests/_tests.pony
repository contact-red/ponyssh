...
primitive \nodoc\ Tests is TestList
  fun tag tests(test: PonyTest) =>
    ...
    test(_TestServerConfigChannelWindow)
    test(_TestServerConfigBadKeyPrecedesWindow)
    test(_TestServerConfigPreservesFields)
    test(_TestServerConfigPreservesDefaults)
    ...
    test(_TestChannelPostAdmissionDebit)
    ...
    test(_TestStrictKexKexinitMustBeFirst)
    ...
    test(_TestChannelPeerPacketSizeBoundary)
    test(_TestChannelPeerWindowProperty)
    test(_TestChannelCustomReceiveWindow)
